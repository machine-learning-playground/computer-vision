...
def get_args():
    ...
    parser.add_argument(
        "--temperature", type=float, default=0.02, help="initial temperature value, if 0, don't use temperature"
    )
    ...
    parser.add_argument(
        "--MLM", default=True, action="store_true", help="whether to use Mask Language Modeling dataset"
    )

    ## itm transformer setting
    parser.add_argument("--itm_depth", type=int, default=2, help="itm transformer self attn layers")

    ## mim transformer setting
    ...
    parser.add_argument(
        "--loss_names", default="sdm+gi2id+mim", help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']"
    )
