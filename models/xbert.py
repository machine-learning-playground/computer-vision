...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # BertModel Backbone loads the BERT encoder
        # add_pooling_layer=False because pooling is unnecessary for MLM (used in classification tasks).
        self.bert = BertModel(config, add_pooling_layer=False)

        # the MLM-specific layer that predicts masked words
        # Contains:
        #   A dense (fully connected) layer
        #   A GELU activation function
        #   A LayerNorm
        #   A final linear layer to project back to vocabulary size
